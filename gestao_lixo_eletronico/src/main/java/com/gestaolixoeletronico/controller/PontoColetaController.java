...
public class PontoColetaController {
    ...
    @PostMapping("/{pontoColetaId}/adicionar-lixo-eletronico/{lixoEletronicoId}")
    public ResponseEntity<PontoColeta> adicionarLixoEletronico(
            @PathVariable Long pontoColetaId,
            @PathVariable Long lixoEletronicoId
    ) {
        return ResponseEntity.ok(service.adicionarLixoEletronico(pontoColetaId, lixoEletronicoId));
    }

    @DeleteMapping("/{pontoColetaId}/remover-lixo-eletronico/{lixoEletronicoId}")
    public ResponseEntity<PontoColeta> removerLixoEletronico(
            @PathVariable Long pontoColetaId,
            @PathVariable Long lixoEletronicoId
    ) {
        return ResponseEntity.ok(service.removerLixoEletronico(pontoColetaId, lixoEletronicoId));
    }
}